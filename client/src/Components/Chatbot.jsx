...
//     {
//       "role": "user",
//       "parts": [{ "text": "The water pressure in my apartment is very low." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "I’m sorry to hear about the issue. Can you provide your apartment number and how long you’ve been experiencing this problem?" }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "I live in apartment 12B, and the water pressure has been low for the past week." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "Thank you for the details. We have reported the issue to the plumbing department. Your reference number is P345678. They will inspect and fix the issue within 48 hours." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "It's been three days, and the water pressure issue still persists." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "We apologize for the delay. The plumbing team has been notified again and they will visit your apartment today." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "Thank you for your prompt response." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "You’re welcome. Please let us know if the issue is not resolved by the end of the day." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "The plumber came and fixed the issue. Thanks for your help!" }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "I’m glad to hear that. If you need any further assistance, feel free to reach out. Have a great day!" }]
//     },
    
//     {
//       "role": "user",
//       "parts": [{ "text": "I need to report a pothole on Main Street." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "Thank you for reporting this. Can you provide the exact location of the pothole and how long it has been there?" }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "The pothole is near 123 Main Street and it's been there for over a month." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "We have reported the pothole to the road maintenance department. Your reference number is R456789. They will address the issue within the next week." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "It's been two weeks, and the pothole is still not fixed." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "We apologize for the delay. The road maintenance team has been reminded and they will fix the pothole by tomorrow." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "Thank you. I'll keep an eye out for the repair." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "You’re welcome. Please let us know if the pothole is not fixed by tomorrow evening." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "The pothole has been repaired. Thanks for your help!" }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "I’m happy to hear that. If you encounter any other issues, feel free to contact us. Have a great day!" }]
//     },
    
//     {
//       "role": "user",
//       "parts": [{ "text": "There is a broken bench in the park near my house." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "Thank you for letting us know. Can you specify the exact location of the bench in the park and when you noticed it was broken?" }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "The bench is near the playground in Maple Park, and it's been broken for about a week." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "We have reported the broken bench to the parks department. Your reference number is P567890. They will repair or replace the bench within 72 hours." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "It's been four days, and the bench is still broken." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "We apologize for the delay. The parks department has been notified again and they will prioritize the repair. It should be fixed by tomorrow." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "Thank you. I appreciate the follow-up." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "You’re welcome. Please let us know if the bench is not fixed by the end of tomorrow." }]
//     },
//     {
//       "role": "user",
//       "parts": [{ "text": "The bench has been fixed. Thank you for your assistance." }]
//     },
//     {
//       "role": "model",
//       "parts": [{ "text": "I’m glad to hear that. If you need any further help, feel free to contact us. Have a great day!" }]
//     }
//   ]
//   `;


//   const context2=`Welcome to the Support Chatbot!
...
function Chatbot() {
  ...
  const contextTemplate = `Welcome to the Support Chatbot!
  I’m here to help you with any issues or concerns you might have. Please provide a brief description of the problem you're experiencing, and I will guide you through the process to get it resolved by the right department.`;
  ...
  const handleMessageSend = async () => {
    ...
    if (transcription.trim() !== "") {
      const responseByBot = await getAnswerLLM(
        `from provided context ${userContext}, reply according to that and ask follow up questions if needed and resolve your query. here is query or question: ${transcription}`
      );
      ...
      const responseByBot = await getAnswerLLM(
        `from provided context ${userContext}, reply according to that and ask follow up questions if needed and resolve your query. here is query or question: ${inputValue}`
      );
  ...
  useEffect(() => {
    const fetchUserHistory = async () => {
      ...
      try {
        ...
        setUserContext(`${contextTemplate} ${response.data.history}`);
      } catch (error) {
          ...
          <div className="chatbot-expanded">
            ...
            >
              {messages.length > 0 ? (
                ...
                <p>Type here or tap the mic to record your message</p>
              )}
            </div>
            ...
            <div className="input-container">
              ...
              >
                {isRecording ? <IoStopSharp /> : <IoMicSharp />}
              </button>
            </div>
            {loading && (
